...
def filter_generic(spectra):
    ...
    return [
        ...
        and instrument_regex.search(block["instrument"])
        and
...
extended_structures = {
    "flavone1": flavone_smart[0],
    "isoflavone1": isoflavone_smart[0],
    "flavone2": flavone_smart[1],
    "isoflavone2": isoflavone_smart[1],
